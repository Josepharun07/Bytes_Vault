...
const Cart = {
    ...
    renderCartPage() {
        ...
        if (cart.length === 0) {
            tbody.innerHTML = '<tr><td colspan="6" style="text-align:center; padding: 2rem;">Your cart is empty. <a href="shop.html">Go Shopping</a></td></tr>';
        ...
        cart.forEach(item => {
            ...
            row.innerHTML = `
                ...
                <td>$${total}</td>
                <td>
                    <button onclick="Cart.remove('${item._id}')" class="btn-danger" style="padding: 5px 10px;">&times;</button>
                </td>
            `;
